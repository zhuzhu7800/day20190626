...
<body>
	...
	<div id="content">
		...
		<div class="sidebar">
			<ul class="l_menu">
				...
				<li><a href="yqlj.html" class="on"><i class="icon-link"></i>友情链接<i
						class="icon-angle-right"></i></a></li>
				<li><a href="#"><i class="icon-building"></i>学校分类<i
						class="icon-angle-right"></i></a></li>
				<li><a href="zyfl2.html"><i class="icon-book"></i>资源分类<i
						class="icon-angle-right"></i></a></li>
			</ul>
		</div>
		<!--左栏结束-->
		...
		<div class="main">
			<div class="main_menu">
				...
				<ul class="r_menu">
					<li><a href="#">下属学校</a></li>
					<li><a href="#" class="on">平级单位</a></li>
					<li><a href="#">县级单位</a></li>
					<li><a href="#">省市级单位</a></li>
					<li><a href="#">国家级单位</a></li>
					<input type="button" class="add_article" value="添加友情链接"
			...
			<div class="main_c">
				<table width="831" border="1" class="main_t">
					<tr class="t_title">
						...
						<td class="width350 a_title">友情链接名称</td>
						<td class="width130">链接地址</td>
						<td class="width130">分类</td>
						<td class="width191">操作</td>
					</tr>
					<tr>
						<td>1</td>
						<td class="a_title">市教科研中心</td>
						<td>http://wljy.jzedu.net/</td>
						<td>平级单位</td>
	...
	<div class="tcbox width500" id="add_article" style="display: none">
		<div class="tc_title">
			<span>添加友情链接</span><a class="tc-close"
				href="javascript:showDialog.hide()" title="关闭"></a>
		</div>
		<form class="tc_content">
			<p class="tc_p01">
				<span class="tc_span02">链接名称:</span><input type="text"
					class="input01 width300" value="市教科研中心">
			</p>
			<p class="tc_p01">
				<span class="tc_span02">链接地址:</span><input type="text"
					class="input01 width300" value="http://wljy.jzedu.net/">
			</p>
			<p class="tc_p01">
				<span class="tc_span02">链接分类:</span> <select name="link_type"
					class="select01">
					<option value="下属学校">下属学校</option>
					<option value="平级单位">平级单位</option>
					<option value="县级单位">县级单位</option>
					<option value="省市级单位">省市级单位</option>
					<option value="国家级单位">国家级单位</option>
				</select>
			</p>
			<div class="tc_btn">
	...
	<div class="tcbox width500" id="a_edit" style="display: none">
		<div class="tc_title">
			<span>编辑友情链接</span><a class="tc-close"
				href="javascript:showDialog.hide()" title="关闭"></a>
		</div>
		<form class="tc_content">
			<p class="tc_p01">
