...
<script>
var name=decodeURI(window.location.search.substr(1));
$(function() {
	show()
});
function show() {
	$("#tou").text(decodeURI(window.location.search.substr(1)));
	$("input[name=add]").val(decodeURI(window.location.search.substr(1)));
	$("input[name=upd]").val(decodeURI(window.location.search.substr(1)));
	$.ajax({
    	"url":"/TGNews/nei/getAll",
		"type":"post",
		"dataType":"json",
			...
			$(result).each(function() {
				$("table").append(""+
						"<tr>"+
							...
							"<td>"+this.time+"</td>"+
							"<td>"+this.author+"</td>"+
							"<td><a href='#' class='t_nav' onClick=TGDialogS('a_edit2','"+this.id+"')>编辑</a>"+
		...
		<div class="sidebar">
			<ul class="l_menu">
				...
				<li><a href="jxyj.html"><i class="icon-beaker"></i>教学研究<i
						class="icon-angle-right"></i></a></li>
				<li><a href="xxzl.html" class="on"><i class="icon-building"></i>学校专栏<i
						class="icon-angle-right"></i></a></li>
				<li><a href="xxgk.html"><i class="icon-bullhorn"></i>信息公开<i
						class="icon-angle-right"></i></a></li>
				<li><a href="hdjl.html"><i class="icon-comments"></i>互动交流<i
						class="icon-angle-right"></i></a></li>
				<li><a href="jgsz.html"><i class="icon-sitemap"></i>机构设置<i
						class="icon-angle-right"></i></a></li>
			...
			<div class="main_menu">
				<ul class="r_menu">
					<div class="position_t">
						<a href="xxzl2.html" id="tou"></a><span>-</span>学校公告
					</div>
		...
		<form class="tc_content">
			...
			<p class="tc_p01">
				<span class="tc_span01">发布时间:</span> <input type="datetime"
					class="input01 width200"> <span class="tc_span01 left100">作者:</span>
