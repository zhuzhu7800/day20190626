			...
			"success":function(result){
				...
				$(result).each(function(i){
					$(".main_t").append("<tr>"+
			          ...
			          "<td>教育新闻</td>"+
			          "<td><a href=\"../tiao/index\" class=\"t_nav\">文章管理</a><a href=\"#\" class=\"t_nav\"  onClick=\"TGDialogS('a_edit3','"+this.id+"')\">编辑</a><a href=\"#\" class=\"t_nav\" onclick='del("+this.id+")'>删除</a></td>"+
			        "</tr>");
				})
			},
		})
...
<div id="content"> 
  ...
  <div class="main">
    <div class="main_menu">
      <ul class="r_menu">
        <div class="position_t"><a href="index.html">教育新闻</a><span>-</span>栏目管理</div>
        <input type="button" class="add_article" value="添加栏目"  onClick="TGDialogS('a_edit2')">
      </ul>
    </div>
    <div class="main_c">
      <table width="831" border="1" class="main_t">
       <!--  <tr class="t_title">
        ...
        <tr>
          <td>1</td>
          <td class="a_title">教育动态</td>
          <td>教育新闻</td>
          <td><a href="index.html" class="t_nav">文章管理</a><a href="#" class="t_nav"  onClick="TGDialogS('a_edit3')">编辑</a><a href="#" class="t_nav">删除</a></td>
        </tr>
        <tr>
          <td>1</td>
          <td  class="a_title">教育新闻</td>
          <td>教育新闻</td>
          <td><a href="index.html" class="t_nav">文章管理</a><a href="#" class="t_nav" onClick="TGDialogS('a_edit3')">编辑</a><a href="#" class="t_nav">删除</a></td>
        </tr>
        <tr>
          <td>1</td>
          <td  class="a_title">热点关注</td>
          <td>教育新闻</td>
          <td><a href="index.html" class="t_nav">文章管理</a><a href="#" class="t_nav" onClick="TGDialogS('a_edit3')">编辑</a><a href="#" class="t_nav">删除</a></td>
        </tr> -->
      </table>
...
<div class="tcbox width500" id="a_edit2" style="display:none">
  <div class="tc_title"><span>添加栏目</span><a class="tc-close" href="javascript:showDialog.hide()" title="关闭"></a></div>
  <form class="tc_content" action="../column/add" method="post">
    <p class="tc_p01"><span class="tc_span02">栏目名称:</span>
      <input type="text" class="input01 width300" value="" name="categoryName" >
    </p>
    <p class="tc_p01"><span class="tc_span02">父级栏目:</span>
      <input type="text" class="input01 width300" value="教育新闻"  disabled='disabled'>
    </p>
    <div class="tc_btn">
...
<div class="tcbox width500" id="a_edit3" style="display:none">
  <div class="tc_title"><span>编辑栏目</span><a class="tc-close" href="javascript:showDialog.hide()" title="关闭"></a></div>
  <form class="tc_content"  action="../column/upd">
  	<input type="hidden" name="id" id="a" >
    <p class="tc_p01"><span class="tc_span02">栏目名称:</span>
      <input type="text" class="input01 width300"  id="b"  name="categoryName">
    </p>
    <p class="tc_p01"><span class="tc_span02">学校:</span>
      <input type="text" class="input01 width300" value="教育新闻"  disabled='disabled'>
    </p>
    <div class="tc_btn">
      <input type="submit" class="tc_submit" value="保存">
