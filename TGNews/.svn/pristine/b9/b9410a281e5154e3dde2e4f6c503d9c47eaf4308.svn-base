...
<script>
	...
	function b(){
		$.ajax({
			"url":"/TGNews/news/tiaojian/"+$(".select01").val(),
			"dataType":"json",
			"type":"post",
			"success":function(result){
				$(".main_t").html("");
...
<div id="content"> 
  ...
  <div class="sidebar">
    <ul class="l_menu">
    	<li><a href="../tiao/index" class="on"><i class="icon-edit" ></i>教育新闻<i
  ...
  <div class="main">
    <div class="main_menu">
      <ul class="r_menu">
        <div class="position_t">教育新闻</div>
        <input type="button" class="add_article" value="添加文章"  onClick="TGDialogS('add_article')">
        <input type="button" class="add_article right15" value="栏目管理" onclick="location.href='../tiao/index2'">
      </ul>
    </div>
    <div class="main_c">
     
      <p class="tc_p02"><span class="tc_span02">分类检索:</span>
        <select name="link_type" class="select01">
         <!--  <option value="0">全部</option>
          <option value="5">教育动态</option>
          <option value="6">教育信息</option>
          <option value="7">热点关注</option> -->
        </select>
    ...
    <div class="main_c">
     ...
     <!--    <tr class="t_title">
        ...
        <tr>
          ...
          <td>教育动态</td>
          <td>太谷教育信息网</td>
          <td><a href="#" class="t_nav" onClick="TGDialogS('a_edit')">编辑</a><a href="#" class="t_nav">置顶</a><a href="#" class="t_nav">删除</a></td>
        </tr>
        <tr>
          <td>1</td>
          <td  class="a_title">市关工委在太师附小检查指导工作</td>
...
<div class="tcbox" id="add_article" style="display:none">
  <div class="tc_title"><span>添加文章</span><a class="tc-close" href="javascript:showDialog.hide()" title="关闭"></a></div>
  
	  <form class="tc_content" action="/TGNews/news/add" method="post">
	    <p class="tc_p01"><span class="tc_span01">文章标题:</span>
	    ...
	    <p class="tc_p01"><span class="tc_span01" >发布时间:</span>
	      <input type="datetime" class="input01 width180" name="createDate">
	      <span class="tc_span01 left20">作者:</span>
	      <input type="datetime" class="input01 width180" value="太谷教育信息网" name="author">
	      <span class="tc_span01 left20">浏览量:</span>
	      <input type="datetime" class="input01 width97" value="0" name="view">
	    </p>
	    <div class="tc_btn">
...
<div class="tcbox" id="a_edit" style="display:none">
  <div class="tc_title"><span>文章编辑</span><a class="tc-close" href="javascript:showDialog.hide()" title="关闭"></a></div>
  <form class="tc_content" action="../news/updss" method="post">
  		<input type="hidden" name="id"  id="e">
    <p class="tc_p01"><span class="tc_span01">文章标题:</span>
      <input type="text" class="input01 width300"  id="a"  name="title">
    </p>
    <!--编辑器 Start-->
    <p class="tc_p01">
    <div class="editor" id="b" name="context"></div>
    </p>
    <p class="tc_p01"><span class="tc_span01">发布时间:</span>
      <input type="text" class="input01 width200"  id="c"  name="createDate">
      <span class="tc_span01 left100">作者:</span>
      <input type="text" class="input01 width200"  id="d" name="author">
    </p>
    <div class="tc_btn">
      <input type="submit" class="tc_submit" value="保存">
      <input type="button" value="取消" class="tc_submit2 left10" onClick="closeDialog('0')">
...
function xiu(id){
	$.ajax({
		"url":"/TGNews/news/selById/"+id,
		"dataType":"json",
		"type":"post",
		"success":function(result){
			$("#e").val(""+result.id+"");
			$("#a").val(""+result.title+"");
			$("#b").text(""+result.context+"");
			$("#c").val(""+result.createDate+"");
			$("#d").val(""+result.author+"");
		},
	})
}
