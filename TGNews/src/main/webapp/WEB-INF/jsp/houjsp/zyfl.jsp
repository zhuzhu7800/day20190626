...
<body>
	...
	<div id="content">
		...
		<div class="sidebar">
			<ul class="l_menu">
				...
				<li><a href="#"><i class="icon-building"></i>学校分类<i
						class="icon-angle-right"></i></a></li>
				<li><a href="zyfl2.html" class="on"><i class="icon-book"></i>资源分类<i
						class="icon-angle-right"></i></a></li>
			</ul>
		</div>
		<!--左栏结束-->
		...
		<div class="main">
			<div class="main_menu">
				<ul class="r_menu">
					<li><a href="zyfl.html" class="on">学段</a></li>
					<li><a href="zyfl2.html">年级</a></li>
					<li><a href="zyfl3.html">科目</a></li>
					<input type="button" class="add_article" value="添加学段"
			...
			<div class="main_c">
				<table width="831" border="1" class="main_t">
					<tr class="t_title">
						...
						<td class="width130">学段名称</td>
						<td class="width191">操作</td>
					</tr>
					<tr>
						<td>1</td>
						<td>小学</td>
						<td><a href="zyfl2.html" class="t_nav">年级管理</a><a href="#"
	...
	<div class="tcbox width500" id="tcbox1" style="display: none">
		<div class="tc_title">
			<span>添加学段</span><a class="tc-close"
				href="javascript:showDialog.hide()" title="关闭"></a>
		</div>
		<form class="tc_content">
			<p class="tc_p01">
				<span class="tc_span02">学段名称:</span> <input type="text"
	...
	<div class="tcbox width500" id="tcbox2" style="display: none">
		<div class="tc_title">
			<span>编辑学段</span><a class="tc-close"
				href="javascript:showDialog.hide()" title="关闭"></a>
		</div>
		<form class="tc_content">
			<p class="tc_p01">
				<span class="tc_span02">学段名称:</span> <input type="text"
					class="input01 width300" value="小学">
			</p>
			<div class="tc_btn">
				<input type="submit" class="tc_submit" value="保存"> <input
					type="button" value="取消" class="tc_submit2 left10"
