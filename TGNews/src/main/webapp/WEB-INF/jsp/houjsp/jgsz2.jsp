	...
	$.ajax({
		...
		"success":function(result){
			...
			$("table").append(""+
					...
					"<td class='width350 a_title'>股室列表</td>"+
			...
			$(result).each(function() {
				$("table").append(""+
						"<tr>"+
							...
							"<td><a href='/TGNews/tiao/jgsz3?"+this.name+"' class='t_nav'>文章管理</a>|<a href='#' class='t_nav' onClick=TGDialogS('tcbox2','"+this.id+"')>编辑</a>"+
...
<body>
		...
		<div class="main">
			<div class="main_menu">
				<ul class="r_menu">
					...
					<input type="button" class="add_article" value="添加股室"
	...
	<div class="tcbox width500" id="tcbox1" style="display: none">
		<div class="tc_title">
			<span>添加股室</span><a class="tc-close"
				href="javascript:showDialog.hide()" title="关闭"></a>
		</div>
		<form class="tc_content" action="/TGNews/gushi/add" enctype="multipart/form-data" method="post">
			<p class="tc_p01">
				<span class="tc_span02">股室名称:</span> <input type="text"
	...
	<div class="tcbox width500" id="tcbox2" style="display: none">
		<div class="tc_title">
			<span>编辑股室</span><a class="tc-close"
				href="javascript:showDialog.hide()" title="关闭"></a>
		</div>
		<form class="tc_content" action="/TGNews/gushi/upd" enctype="multipart/form-data" method="post">
