...
<body>
		...
		<div class="main">
			<div class="main_menu">
				<ul class="r_menu">
					...
					<li><a href="zyfl2.html">年级</a></li>
					<li><a href="zyfl3.html" class="on">科目</a></li>
					<input type="button" class="add_article" value="添加科目"
			...
			<div class="main_c">
				<p class="tc_p02">
					...
					</select> <select name="link_type" class="select01 left10">
						<option value="全部">全部</option>
			...
			<div class="main_c">
				<table width="831" border="1" class="main_t">
					<tr class="t_title">
						...
						<td class="width130">科目名称</td>
						<td class="width130">所属学段</td>
						<td class="width130">所属年级</td>
	...
	<div class="tcbox width500" id="tcbox1" style="display: none">
		<div class="tc_title">
			<span>添加科目</span><a class="tc-close"
				href="javascript:showDialog.hide()" title="关闭"></a>
		</div>
		<form class="tc_content">
			<p class="tc_p01">
				<span class="tc_span02">科目名称:</span> <input type="text"
			...
			<p class="tc_p01">
				<span class="tc_span02">所属年级:</span> <select name="link_type"
					class="select01">
					<option value="一年级">一年级</option>
					<option value="二年级">二年级</option>
					<option value="三年级">三年级</option>
	...
	<div class="tcbox width500" id="tcbox2" style="display: none">
		<div class="tc_title">
			<span>编辑科目</span><a class="tc-close"
				href="javascript:showDialog.hide()" title="关闭"></a>
		</div>
		<form class="tc_content">
			<p class="tc_p01">
				<span class="tc_span02">科目名称:</span> <input type="text"
					class="input01 width300" value="语文">
			</p>
			<p class="tc_p01">
				<span class="tc_span02">所属学段:</span> <select name="link_type"
					class="select01">
