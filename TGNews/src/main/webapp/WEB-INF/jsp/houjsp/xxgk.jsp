...
<script>
	...
	function b(){
		$.ajax({
			"url":"/TGNews/newsx/tiaojian/"+$(".select01").val(),
			"dataType":"json",
			"type":"post",
			"success":function(result){
				$(".main_t").html("");
...
<body>
	...
	<div id="content">
		...
		<div class="main">
			<div class="main_menu">
				<ul class="r_menu">
					<div class="position_t">信息公开</div>
					<input type="button" class="add_article" value="添加文章" onClick="TGDialogS('add_article')">
					<input type="button" class="add_article right15" value="栏目管理" onclick="location.href='../tiao/xxgk2'">
				</ul>
			</div>
			<div class="main_c">
				<p class="tc_p02">
					<span class="tc_span02">分类检索:</span> <select name="link_type"
						...
						<option value="股室动态">股室动态</option>
						<option value="办事指南">办事指南</option> -->
					</select> <input type="button" class="search01" value="搜索" onclick="b()">
				</p>
			</div>
			<div class="main_c">
	...
	<div class="tcbox" id="add_article" style="display: none">
		...
		<form class="tc_content" action="../newsx/add">
			<p class="tc_p01">
	...
	<div class="tcbox" id="a_edit" style="display: none">
		...
		<form class="tc_content" action="../newsx/updss">
			...
			<!--编辑器 Start-->
			<p class="tc_p01">
			<div class="editor" name="context" id="c"></div>
			<p class="tc_p01">
				<span class="tc_span01">发布时间:</span> 
